...
public class MeuCadastroActivity extends AppCompatActivity {
    ...
    private void carregaMeusCursos(DataSnapshot snapshot){

    }

    private void goToAlterarCadastro(Aluno aluno){
        Intent it = new Intent(getApplicationContext(), AlterarCadastroActivity.class);
